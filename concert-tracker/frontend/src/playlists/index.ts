...
// ./pages plus the add-to-playlist sidebar panel implemented below. Playback
// lives in player.ts (it extends the queue); this file only ever *calls*
// Player.openSidebar / Player.closeSidebar.
//
