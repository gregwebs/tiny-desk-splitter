...
# Drift guard: static/*.js must be exactly what `ts-build` produces from the
# current frontend/src. A diff here means someone hand-edited the generated
...
ts-verify: ts-build
    git diff --exit-code -- concert-tracker/static/player.js concert-tracker/static/playlists.js concert-tracker/static/splitter.js
